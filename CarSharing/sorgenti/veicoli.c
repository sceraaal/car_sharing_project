...
/*
FUNZIONE: pulisciESospendi
-------------------------
Pulisce lo schermo e sospende l'esecuzione del programma per un breve periodo, permettendo all'utente di vedere il messaggio prima che lo schermo venga pulito.
...
POST-CONDIZIONI:
- La funzione pulisce lo schermo e sospende l'esecuzione del programma per 2 secondi, permettendo all'utente di vedere il messaggio prima che lo schermo venga pulito.

SIDE-EFFECT:
- La funzione utilizza comandi specifici del sistema operativo per pulire lo schermo e sospendere l'esecuzione.
*/
void pulisciESospendi()
{
#ifdef _WIN32
